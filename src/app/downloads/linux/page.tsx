...
export const metadata: Metadata = {
  ...generateMetadata('Nexus AI for Linux | Nexus AI', 'Download the Nexus AI desktop app for Linux.', '/downloads/linux'),
};
    ...
    <>
      <section className="pt-32 pb-20 md:pt-40">
        <div className="main-container text-center space-y-6">
          ...
          <h1 className="mx-auto max-w-[640px]">Nexus AI for Linux</h1>
          <p className="text-tagline-1 text-secondary/60 mx-auto max-w-[480px]">
            Download the Nexus AI desktop app for Linux. This page is being built. Check back soon.
          </p>
          <Link href="/contact">
