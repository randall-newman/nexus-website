...
export const metadata: Metadata = {
  ...generateMetadata('API Documentation | Nexus AI', 'Build on top of Nexus AI with our developer API.', '/developers/docs'),
};
    ...
    <>
      <section className="pt-32 pb-20 md:pt-40">
        <div className="main-container text-center space-y-6">
          ...
          <h1 className="mx-auto max-w-[640px]">API Documentation</h1>
          <p className="text-tagline-1 text-secondary/60 mx-auto max-w-[480px]">
            Build on top of Nexus AI with our developer API. This page is being built. Check back soon.
          </p>
          <Link href="/contact">
