    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-12">
      ...
      <div className="relative z-10 w-full max-w-[400px] space-y-8">
        <div className="text-center">
          ...
          <p className="mt-1.5 text-sm text-white/60">Log in to your account to continue</p>
        </div>

        <div className="rounded-2xl bg-white/10 border border-white/20 p-8 backdrop-blur-md">
          <div className="space-y-3">
            <a
              href="https://app.mynexusai.com/login?provider=google"
            ...
            <a
              href="https://app.mynexusai.com/login?provider=apple"
          ...
          <form
            onSubmit={(e) => {
              e.preventDefault();
              window.location.href = 'https://app.mynexusai.com/login';
            }}
            className="space-y-4"
          >
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <a href="https://app.mynexusai.com/forgot-password" className="text-xs text-white/60 hover:text-white hover:underline">
                  Forgot password?
                </a>
              </div>
