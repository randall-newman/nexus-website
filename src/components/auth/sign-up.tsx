      ...
      <div className="flex flex-col bg-white px-6 py-8 sm:px-10 xl:px-16">
        ...
        <div className="mx-auto flex w-full max-w-[400px] flex-1 flex-col justify-center py-10">
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-[12px] text-secondary/35">or sign up with email</span>
            <div className="h-px flex-1 bg-stroke-3" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="password" className="block text-[13px] font-medium text-secondary/70">
                Password
              </label>
              <input
                id="password"
          ...
          <p className="mt-2 text-center text-[13px] text-secondary/40">
            <Link href="/forgot-password" className="hover:text-secondary/60 hover:underline">
