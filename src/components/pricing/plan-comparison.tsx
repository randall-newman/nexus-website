...
const plans: Plan[] = [
  {
    ...
    rows: [
      ...
      'Creative Studio preview (no image or video generation)',
      'Code and Artifacts preview',
      '2 file uploads (up to 5 MB each)',
      'Community support',
    ],
  },
  {
    ...
    rows: [
      'Unlimited AI Chat',
      'Research Mode (20 queries/month)',
      'Unlimited Folders',
      'Full Nexus AI Academic workspace',
      'Creative Studio (100 credits/month) — image and audio generation',
      'Code: generation, review and CLI',
      'Artifacts: full editing and export',
      'Unlimited file uploads (up to 25 MB)',
  ...
  },
  {
    ...
    badgeIcon: Zap,
    rows: [
      'Research Mode, unlimited queries',
      'Advanced AI models on every feature',
      'Unlimited Nexus AI Academic',
      'Creative Studio (750 credits/month) — image, audio and video generation',
      'AI Video: 50 videos/month included',
