import { aiEssayWriterFaqItems } from '@/src/components/features/ai-essay-writer';
...
export { aiEssayWriterFaqItems };

const AiEssayWriterFaq = () => {
  return (
      ...
      <div className="main-container">
        <div className="flex flex-col items-start justify-center gap-y-6 overflow-hidden lg:flex-row lg:gap-x-18 lg:gap-y-0">
                ...
                <div className="space-y-3">
                  ...
                  <TextReveal delay={0.3}>
                    <p className="text-background-14/60 mx-auto max-w-[450px] lg:mx-0">
                      Everything you need to know about the Nexus AI Essay Writer. Still have
          ...
          <RevealAnimation delay={0.2} direction="right" offset={100} className="w-full lg:w-1/2">
            <Accordion
              defaultOpen={aiEssayWriterFaqItems[0].value}
              className="space-y-4"
              aria-label="AI Essay Writer FAQ"
            >
              {aiEssayWriterFaqItems.map((item) => (
                <AccordionItem
                  key={item.value}
                  value={item.value}
...
export default AiEssayWriterFaq;
